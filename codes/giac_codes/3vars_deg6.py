...
def assign_abc(fcn):
  global X,a,b,c
  fcn=fcn.subst(b,[X[1],X[2],-X[1]])  
  fcn=fcn.subst(c,[X[0],X[1]+2*X[2],X[1]])
...
print p3
"""
2*t^2*x0^2*x2-2*t^2*x0*x1^2-4*t^2*x0*x1*x2+2*t*x0*x1*x2-2*t*x1^3-4*t*x1^2*x2+2*x0^2*x1+4*x0^2*x2+2*x1^3+8*x1^2*x2+24*x1*x2^2+15*x2^3
2*t^2*x0*x1*x2+4*t^2*x0*x2^2-2*t^2*x1^3-8*t^2*x1^2*x2-8*t^2*x1*x2^2+2*t*x0*x2^2-2*t*x1^2*x2-4*t*x1*x2^2-2*x0^3-2*x0*x1^2-8*x0*x1*x2-8*x0*x2^2+4*x1^3+x1*x2^2
2*t^2*x0*x1*x2-2*t^2*x1^3-4*t^2*x1^2*x2-2*t*x0*x1*x2+2*t*x1^3+4*t*x1^2*x2+2*x0*x1*x2-2*x1^3-4*x1^2*x2
"""

F=assign_abc(F)
print "The result sos: "
print F
print "number of monomials: ", len(F) #21
#4*x0^6+12*x0^4*x1^2+48*x0^4*x1*x2+48*x0^4*x2^2-16*x0^3*x1^3+12*x0^3*x1*x2^2+12*x0^2*x1^4+48*x0^2*x1^3*x2+180*x0^2*x1^2*x2^2+396*x0^2*x1*x2^3+216*x0^2*x2^4+24*x0*x1^4*x2+12*x0*x1^3*x2^2-144*x0*x1^2*x2^3-144*x0*x1*x2^4+8*x1^6+216*x1^4*x2^2+636*x1^3*x2^3+945*x1^2*x2^4+720*x1*x2^5+225*x2^6
...
print p3.factors()
"""
[2*t^2*x0^2*x2-4*t^2*x0*x2*x1-2*t^2*x0*x1^2+2*t*x0*x2*x1-4*t*x2*x1^2-2*t*x1^3+4*x0^2*x2+2*x0^2*x1+15*x2^3+24*x2^2*x1+8*x2*x1^2+2*x1^3,1]
[2*t^2*x0*x1*x2+4*t^2*x0*x2^2-2*t^2*x1^3-8*t^2*x1^2*x2-8*t^2*x1*x2^2+2*t*x0*x2^2-2*t*x1^2*x2-4*t*x1*x2^2-2*x0^3-2*x0*x1^2-8*x0*x1*x2-8*x0*x2^2+4*x1^3+x1*x2^2,1]
[2,1,t^2-t+1,1,x1,1,x0*x2-x1^2-2*x1*x2,1]
"""

print "Factors of p1,p2,p3 in the hyperplane x1=0"
print p1.subst(X[1],0).factors()
print p2.subst(X[1],0).factors()
print p3.subst(X[1],0).factors()
"""
[x2,1,2*t^2*x0^2+4*x0^2+15*x2^2,1]
[2,1,x0,1,2*t^2*x2^2+t*x2^2-x0^2-4*x2^2,1]
[0,1]
"""
exit(0)
