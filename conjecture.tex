...
$\Q$-rational points. More generally we have the following lemma.
...
no non-trivial forms over $\Q$ of degree $d$ that have all these $P_i$ as zeros.
\end{none}
...
% M>N-M \ge d+1
\begin{prop}
A general construction of a $2d$-adic ternary form over $\Q$ ($d\in 2\N+1$) such that
\begin{itemize}
